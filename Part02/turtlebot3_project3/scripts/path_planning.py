...
def GetUserInput():
    ...
    print("---------------------------------------------------------------------------\n")
    while unanswered:
        # Get and check user inputs for start conditions
        while True:
        ...
        # Get and check user inputs for goal conditions
        while True:
        ...
        # Get and check user inputs for left and right RPM
        while True:
        ...
        # Get and check user input for clearance
        clearance = int(input("Enter the desired clearance space for navigating around buildings (1-19): "))
