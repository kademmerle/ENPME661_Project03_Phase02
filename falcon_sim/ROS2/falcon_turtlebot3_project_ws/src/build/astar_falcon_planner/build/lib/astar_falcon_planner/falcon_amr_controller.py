...
class RobotAStarPlannerNode(Node):
    def __init__(self):
        ...
        self.get_logger().info(f'start passed: {int_start}')
        self.get_logger().info(f'End passed: {int_end}')
        self.get_logger().info(f'robot radius: {robot_radius}')
        self.get_logger().info(f'clearance passed: {clearance}')
        self.get_logger().info(f'goal thresh passed: {goal_threshold}')
        self.get_logger().info(f'wheel radius passed: {wheel_radius}')
        self.get_logger().info(f'wheel distance passed: {wheel_distance}')
