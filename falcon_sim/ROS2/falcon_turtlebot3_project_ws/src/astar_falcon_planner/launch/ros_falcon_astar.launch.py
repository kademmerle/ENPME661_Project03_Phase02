...
def generate_launch_description():
    ...
    launch_falcon_sim = ExecuteProcess(
        cmd=[[
            ' ./Falcon.sh ',
            '-scenario=/home/cgcollins91/Projects/ENPME661_Project03_Phase02/falcon_sim/Scenarios/AMRPathPlanning/AMRPathPlanning.usda'
            ]],
        cwd="/home/cgcollins91/duality/falconsim/",
        shell=True
    )
